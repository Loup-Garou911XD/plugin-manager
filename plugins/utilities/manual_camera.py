...
class Manual_camera_window(bui.MainWindow):
    def __init__(self, origin_widget):
        ...
        self.target_xminus = bui.buttonwidget(
            parent=self._root_widget,
            size=button_size,
            label=babase.charstr(babase.SpecialChar.LEFT_ARROW),
            repeat=True,
        ...
        self.target_xplus = bui.buttonwidget(
            parent=self._root_widget,
            size=button_size,
            label=babase.charstr(babase.SpecialChar.RIGHT_ARROW),
            repeat=True,
        ...
        self.target_yplus = bui.buttonwidget(
            parent=self._root_widget,
            size=button_size,
            label=babase.charstr(babase.SpecialChar.UP_ARROW),
            repeat=True,
        ...
        self.target_yminus = bui.buttonwidget(
            parent=self._root_widget,
            size=button_size,
            label=babase.charstr(babase.SpecialChar.DOWN_ARROW),
            repeat=True,
        ...
        bui.containerwidget(edit=self._root_widget, cancel_button=self._done)
