...
default_config = {
    ...
    'O Target Trans Lang': babase.app.locale.default_locale,
    'Y Source Trans Lang': 'Auto Detect',
    'Y Target Trans Lang': babase.app.locale.default_locale,
}
...
def translate(text, _callback, source='auto', target='en'):
    ...
    result = data[
        (data.find('"result-container">'))
        + len('"result-container">') : data.find(
...
class NewPW(bauiv1lib.party.PartyWindow):
    ...
    def _translate_your_chat(self):
        ...
        translated = threading.Thread(
            target=translate,
            args=(
                str(bui.textwidget(query=self._text_field)),
                _apply_translation,
    ...
    def _translate_other(self, msg: str):
        ...
        if (
            ...
            < self._double_press_interval
        ) and (self._last_msg_clicked == msg):
            show_translate_result = False
        ...
        self._translated_msg = threading.Thread(
            target=translate,
            args=(
                split_msg,
                _apply_translation,
...
class TranslateWindow:
    def __init__(self):
        self.tips = [
            'Double click \'Trans\' button to\nquickly open translation settings',
            'Click others message to\ntranslate them',
            'Double click message to copy them!',
            'Close & reopen chat window\n to see original messages',
        ]
        ...
        self._root_widget = bui.containerwidget(
            ...
            scale=(
                2
                if self._uiscale is babase.UIScale.SMALL
                else 1.4 if self._uiscale is babase.UIScale.MEDIUM else 1.3
            ),
            on_outside_click_call=babase.Call(self._back, sound=True),
        )

        self._tips_text = bui.textwidget(
            parent=self._root_widget,
            color=(0, 1, 1),
            h_align='center',
            v_align='center',
        ...
        self.other_chat = bui.textwidget(
            parent=self._root_widget,
            color=(1, 1, 1),
            h_align='left',
            v_align='center',
        ...
        self.other_chat_arrow = bui.textwidget(
            parent=self._root_widget,
            color=(1, 1, 1),
            h_align='center',
            v_align='center',
        ...
        self.your_chat_arrow = bui.textwidget(
            parent=self._root_widget,
            color=(1, 1, 1),
            h_align='center',
            v_align='center',
        ...
        self.other_source_button = PopupMenu(
            parent=self._root_widget,
            position=(54, 140),
            autoselect=False,
        ...
        self.other_target_button = PopupMenu(
            parent=self._root_widget,
            position=(243, 140),
            autoselect=False,
            on_value_change_call=babase.Call(
        ...
        self.your_source_button = PopupMenu(
            parent=self._root_widget,
            position=(54, 55),
            autoselect=False,
            on_value_change_call=babase.Call(
        ...
        self.your_target_button = PopupMenu(
            parent=self._root_widget,
            position=(243, 55),
            autoselect=False,
            on_value_change_call=babase.Call(
